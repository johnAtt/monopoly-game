...
Monopoly.updatePlayersMoney = function (player, amount) {
    ...
    Monopoly.moneyUpdate(Monopoly.totalPlayers);
}
    ...
    Monopoly.initPopups = function () {
        $(".popup-page#intro").find("button").click(function () {
            ...
            if (Monopoly.isValidInput("numofplayers", numOfPlayers)) {
                ...
                Monopoly.totalPlayers = numOfPlayers;
                Monopoly.closePopup();
            }
        });
    };

//updating the money write on the screen every time that the money change for any player//
    Monopoly.moneyUpdate = function (numOfPlayers) {
        for (var i = 1; i <= numOfPlayers; i++) {
            var cash = $("#player" + i).attr("data-money");
            $(".player" + i + "cash").text("player" + i + ": $" + cash);
        }
    }
    ...
    Monopoly.createPlayers = function (numOfPlayers) {
        ...
        Monopoly.moneyUpdate(numOfPlayers);
    };
